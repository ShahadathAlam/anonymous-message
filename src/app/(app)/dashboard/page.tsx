...
import { Loader2, RefreshCcw, Sun, Moon } from "lucide-react";
...
export default function Page() {
  ...
  return (
    // <div
    //   className={`my-8 mx-4 md:mx-8 lg:mx-auto p-6 rounded w-full max-w-6xl ${
    ...
    <div
      className={
        "my-8 mx-4 md:mx-8 lg:mx-auto p-6 rounded w-full max-w-6xl bg-white text-gray-900 shadow-md transition-colors"
      }
    >
